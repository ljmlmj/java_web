...
public class BoardReplyWriteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (mb != null) { // 로그인한 회원
			...
			String url = "/boardReplyWrite.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (boardDao.reqUpdate(reply_group, reply_order)) {
			...
			System.out.println("reply_group : " + board.getReply_group() 
							+ ", reply_order : " + board.getReply_order() 
							+ ", reply_indent : " + board.getReply_indent());
		}
